<#
.SYNOPSIS
    Vedak IT Toolkit - Microsoft Sync Configuration

.DESCRIPTION
    Removes Microsoft OneDrive and disables Microsoft Edge synchronization.
#>

function Remove-OneDrive {

    Show-Header "Remove OneDrive"
    ...
    if ($Removed) {
        Write-Success "OneDrive uninstall command executed."
    }
    else {
...
function Run-AllMicrosoftSettings {
    ...
    Write-Info "Applying recommended settings..."
    ...
    Write-Success "All recommended Microsoft settings have been applied."
...
function Show-MicrosoftSyncMenu {
    ...
    do {
        ...
        Write-Host "1. Remove OneDrive (Recommended)"
        Write-Host "2. Disable Edge Sync"
        Write-Host "3. Apply All Recommended Settings"
        Write-Host "4. Back"
        Write-Host ""
